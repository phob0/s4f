...
const TaskButtonStatus = (props, updateStatus) => {
              ...
              <Grid item xs display="flex" justifyContent="center" alignItems="center">
                <Card sx={{ width: 250 }}>
                  ...
                  <CardActions style={{justifyContent: 'center'}}>
                      ...
                      {
                        if (status === "NEW") {
                          <Button variant="contained" color="secondary" onClick={() => updateTaskStatus(task)}>
                                  Start
                                </Button>
                        } else if (status === "STARTED") {
                           <Button variant="contained" color="error" onClick={() => updateTaskStatus(task)}>
                                  End Task
                                </Button>
                        } else {
